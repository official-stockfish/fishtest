...
def setup_parameters(worker_dir):
    ...
    parser.add_argument(
        ...
        type=str,
        help="Useful only when running multiple workers concurrently: an existing absolute path to be used to globally cache on disk certain downloads, reducing load on github or net server.",
    )
    parser.add_argument(
        "-C",
        "--compiler",
