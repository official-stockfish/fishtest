(function() {
    let raw = [], chart_object, chart_data, data_cache = [], smoothing_factor = 0, smoothing_max = 20, columns = [], viewAll = false;
    ...
    function redraw(animate) {
        chart_options.animation = animate ? {
            duration: 800,
            easing: "out"
        } : {};
    ...
    document.addEventListener("DOMContentLoaded", ()=>{
        ...
        google.charts.load("current", {
            ...
            callback: function() {
                ...
                document.getElementById("dropdown_individual").addEventListener("click", (e)=>{
