...
<div id="users-table-handler" class="dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <li><span class="dropdown-item" data-handle-target-custom="idle-users">Blocked</span></li>
    <li><span class="dropdown-item" data-handle-target-custom="blocked-users">Idle</span></li>
  </ul>
</div>
