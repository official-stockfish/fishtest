...
<div class="col-limited-size">
  ...
  <form method="POST" aria-labelledby="register-heading">
    ...
    <div id="password-help" class="form-text mb-3">Eight or more characters: a password too simple or trivial to guess will be rejected.</div>
    ...
    <div id="password2-help" class="form-text mb-3">Please repeat your password.</div>
    ...
    <div id="tests_repo_info_modal" class="modal fade" tabindex="-1" aria-labelledby="tests_repo_info_modal_label" role="dialog">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          it is not needed for resources contribution, e.g. https://github.com/user1/Stockfish .
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="recaptcha-help" class="form-text mb-3">This site is protected by reCAPTCHA to ensure you're not a robot. Simply click the checkbox to proceed.</div>
