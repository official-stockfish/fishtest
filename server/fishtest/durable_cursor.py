...
class DurableCursor(Cursor):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(DurableCursor, self).__init__(*args, **kwargs)
    ...
    def next(self):
        ...
        try:
            next_item = super(DurableCursor, self).next()
            ...
            self.retry_cursor = DurableCursor(*self.retry_args,
                                                      **self.retry_kwargs)
            return self.retry_cursor.next()