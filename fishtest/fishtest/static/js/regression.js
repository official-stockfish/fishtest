(function() {
	...
	function draw_fishtest() {
		...
		var fishtest_datatable = new google.visualization.DataTable();
	        ...
	        fishtest_datatable.addColumn({id:'eloplus', type:'number', role:'interval'});
	        fishtest_datatable.addColumn({id:'elominus', type:'number', role:'interval'});
		...
		var options_lines = {
            lineWidth: 3,
            intervals: { style: 'bars'}, //, barWidth: 0.1
            legend: 'none',
            chartArea:{left:50,top:50, width:'90%',height:450},
	...
	function draw_jl_tests(test_id) {
		...
		data.sort(function(a,b){
			var d1 = new Date(a.date_committed), d2 = new Date(b.date_committed); 
			if (d1.getTime() > d2.getTime()) {return 1} else {return -1}
		});
		...
		var datatable = new google.visualization.DataTable();
	        ...
	        datatable.addColumn({id:'eloplus', type:'number', role:'interval'});
	        datatable.addColumn({id:'elominus', type:'number', role:'interval'});
