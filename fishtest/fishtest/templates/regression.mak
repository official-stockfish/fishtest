...
<div class="btn-group">
<button id="btn_select_jl_test" type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
	<span id="btn_select_jl_test_caption">Select Run</span>&nbsp;<span class="caret"></span>
  </button>
  <ul class="dropdown-menu" role="menu" id="dropdown_jl_tests"></ul>
</div>
